  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-it-green selection:text-white">
      ...
      <main>
        {/* --- HERO SECTION:  --- */}
          <HeroSection
            backgroundText="ReliefHumanitarian"
            topLabel="A Legacy of Digital Empowerment"
            title="ReliefHumanitarian &"
            highlight="ReliefHumanitarian"
            footerText="Innovation • Inclusion • ReliefHumanitarianReliefHumanitarian"
          />
      </main>
<div style={{ 
      display: 'flex', 
