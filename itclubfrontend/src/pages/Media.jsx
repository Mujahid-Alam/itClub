...
const Media = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-it-green selection:text-white">
      ...
      <main>
        {/* --- HERO SECTION: Consistent Small Typography --- */}
        ...
        <div className="relative z-10 pt-6">
            <p className="text-it-green font-bold text-[9px] uppercase tracking-[0.6em] mb-2">Visual Stories</p>
            <h2 className="text-3xl md:text-4xl font-black text-white tracking-tighter uppercase leading-none">
            MEDIA <span className="text-it-green italic">CENTRE</span>
            </h2>
            <div className="mt-8 flex items-center justify-center gap-4">
            <span className="h-[1px] w-4 bg-white/10"></span>
            <p className="text-white/40 text-[9px] uppercase tracking-[0.4em] font-semibold">Events • Outreach • Moments</p>
            <span className="h-[1px] w-4 bg-white/10"></span>
            </div>
        </div>
        </section>
